...
export function getTexture(name) {
  // This function would normally use the CDN_MAP and loader, but we'll keep it simple
  // For now, we'll just return a basic texture based on the painter
  const painter = painters[name] || painters.rocky;
  return canvasTexture(256, painter);
}
